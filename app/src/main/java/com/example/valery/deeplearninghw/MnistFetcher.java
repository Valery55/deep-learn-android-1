...
public class MnistFetcher {
    ...
    protected File BASE_DIR = new File(Environment.getExternalStorageDirectory(), "temp");
//    protected File BASE_DIR = new File("/storage/MicroSD", "temp");
    ...
    public File downloadAndUntar() throws IOException {
        ...
        String message = "ExternalStorageDir: " + Environment.getExternalStorageDirectory()
        + ", ExternalStorageState: " + Environment.getExternalStorageState()
        + ", DataDir: " + Environment.getDataDirectory()
        + ", RootDir: " + Environment.getRootDirectory();

        if (!(baseDir.isDirectory() || baseDir.mkdir())) {
            throw new IOException("Could not mkdir " + baseDir + System.lineSeparator() + message);
        }
